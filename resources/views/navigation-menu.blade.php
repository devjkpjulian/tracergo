        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endif
                    @if(auth()->check() && auth()->user()->trial == true)
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{route('visitors.destroy',auth()->user()->id)}}">
                                @method('delete')
                                @csrf

                                <x-jet-dropdown-link href="{{route('visitors.destroy',auth()->user()->id)}}"
